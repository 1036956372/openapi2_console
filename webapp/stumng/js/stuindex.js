Ext.onReady(function() {
			...
			store.on('beforeload', function() {
				this.baseParams = {
					xmmc : Ext.getCmp('grade').getValue()
				};
			});
			// 每页显示条数下拉选择框
			...
			var grid = new Ext.grid.GridPanel({
						...
						title : '<span class="commoncss">学生信息详情</span>',
						margins : '3 3 3 3',
						height : 500,
						frame : true,
						autoScroll : true,
